...
write.table(filtered.norm.data.limma.test.imp, file="C:/Users/k16206jp/OneDrive - The University of Manchester/OMD paper joint editing folder/6 OMD Paper/Patient Samples MS Analysis/Proteome/2 DEP Processing/filtered normalised proteome post imputation.txt", sep="\t", quote=F)
filtered.norm.data.limma.test.imp.with.titles <- cbind(ColumnTitles,filtered.norm.data.limma.test.imp)
write.table(filtered.norm.data.limma.test.imp.with.titles, file="C:/Users/k16206jp/OneDrive - The University of Manchester/OMD paper joint editing folder/6 OMD Paper/Patient Samples MS Analysis/Proteome/2 DEP Processing/filtered normalised proteome post imputation with titles.txt", sep="\t", quote=F)
...
m.design <- c("N","N","N","N","N","N","N","N","N","N","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","N","N","N","N","N","N","N","N","N","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y")
...
cont.matrix <- makeContrasts("Mets vs Non-Mets" =Y - N,
...
#export results
write.table(tT, file="C:/Users/k16206jp/OneDrive - The University of Manchester/OMD paper joint editing folder/6 OMD Paper/Patient Samples MS Analysis/Proteome/2 DEP Processing/Adjusted P value Data.txt", sep="\t",quote=F, row.names = F)
