...
PAMPAO <- filtered.norm.data.limma.test[,c(1:6)]
head(PAMPAO)
...
#export results
write.table(tT, file="C:/Users/k16206jp/OneDrive - The University of Manchester/OMD paper joint editing folder/6 OMD Paper/OMD Cells MS analysis/Proteome/DEP analysis no missing values/Adjusted P value Data.txt", sep="\t",quote=F, row.names = F)
