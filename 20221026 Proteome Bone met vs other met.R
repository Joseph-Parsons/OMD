...
write.table(filtered.norm.data.limma.test.imp.with.titles, file="C:/Users/k16206jp/OneDrive - The University of Manchester/JP Thesis and Papers/6 OMD Paper/Figure 1 Patient MS and OMD identification/Bone met vs other met filtered normalised proteome post imputation with titles.txt", sep="\t", quote=F)
...
log.sub.raw.data.matrix<-log.sub.raw.data.matrix[,c(11:25,35:44)]
head(log.sub.raw.data.matrix)
m.design <- c("N","N","N","N","Y","Y","N","Y","Y","Y","Y","Y","Y","N","Y","N","N","Y","Y","Y","Y","Y","Y","N","Y")
...
cont.matrix <- makeContrasts("Bone Mets vs Other Mets" =Y - N,
...
#export results
write.table(tT, file="C:/Users/k16206jp/OneDrive - The University of Manchester/JP Thesis and Papers/6 OMD Paper/Figure 1 Patient MS and OMD identification/Bone met vs other met Adjusted P value Data.txt", sep="\t",quote=F, row.names = F)
