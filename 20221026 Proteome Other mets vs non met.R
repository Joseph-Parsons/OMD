...
write.table(filtered.norm.data.limma.test.imp.with.titles, file="C:/Users/k16206jp/OneDrive - The University of Manchester/JP Thesis and Papers/6 OMD Paper/Figure 1 Patient MS and OMD identification/Other met vs non met filtered normalised proteome post imputation with titles.txt", sep="\t", quote=F)
...
log.sub.raw.data.matrix<-log.sub.raw.data.matrix[,c(1:14,17,24,26:36,43)]
head(log.sub.raw.data.matrix)
m.design <- c("N","N","N","N","N","N","N","N","N","N","Y","Y","Y","Y","Y","Y","N","N","N","N","N","N","N","N","N","Y","Y","Y")
...
cont.matrix <- makeContrasts("Other Mets vs Non-Mets" =Y - N,
...
#export results
write.table(tT, file="C:/Users/k16206jp/OneDrive - The University of Manchester/JP Thesis and Papers/6 OMD Paper/Figure 1 Patient MS and OMD identification/Other met vs non met Adjusted P value Data.txt", sep="\t",quote=F, row.names = F)
